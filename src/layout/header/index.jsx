      ...
      <AppBar position="static" style={{backgroundColor: "white"}}>
        <Toolbar>
          <Typography
            ...
            noWrap
            component="div"
            sx={{ display: { xs: 'none', sm: 'block', color: "black", marginLeft: '20%' } }}
          >
            <Link to="/dashboard" style={{color: "black"}} >Instagram</Link>
          </Typography>
          <Search style={{border: "1px solid grey", marginLeft: "15%", height: "35px"}}>
            <SearchIconWrapper>
              <SearchIcon style={{color: "grey"}} />
            </SearchIconWrapper>
            <StyledInputBase style={{color: "grey"}}
              placeholder="Search…"
